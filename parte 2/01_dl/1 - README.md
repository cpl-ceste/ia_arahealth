...
Todo el flujo de trabajo se ha unificado en el notebook de Python incluido en esta carpeta: `1_dl_yolo_deteccion_tumores.ipynb`.


## Parte 1: Configuración y Datos

Para comenzar la práctica, abre el archivo `1_dl_yolo_deteccion_tumores.ipynb`. En las primeras secciones del documento:
